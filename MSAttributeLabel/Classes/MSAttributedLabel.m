...
static inline NSDictionary * NSAttributedStringAttributesFromLabel(MSAttributedLabel *label) {
...
@property (readwrite, nonatomic, strong) MSAttributedLabelLink *activeLink;
@property (readwrite, nonatomic, strong) NSArray *accessibilityElements;

- (void) longPressGestureDidFire:(UILongPressGestureRecognizer *)sender;
@end

@implementation MSAttributedLabel {
@private
...
- (void)addLinks:(NSArray *)links {
    ...
    for (MSAttributedLabelLink *link in links) {
        if (link.attributes) {
                                  ...
                                  attributes:(NSDictionary *)attributes
{
    ...
    for (NSTextCheckingResult *result in results) {
        ...
        MSAttributedLabelLink *link = [[MSAttributedLabelLink alloc] initWithAttributes:attributes
...
- (MSAttributedLabelLink *)linkAtPoint:(CGPoint)point {
    ...
    MSAttributedLabelLink *result = [self linkAtCharacterIndex:[self characterIndexAtPoint:point]];
...
- (MSAttributedLabelLink *)linkAtRadius:(const CGFloat)radius aroundPoint:(CGPoint)point {
    ...
    MSAttributedLabelLink *link = nil;
...
- (MSAttributedLabelLink *)linkAtCharacterIndex:(CFIndex)idx {
...
- (void)setActiveLink:(MSAttributedLabelLink *)activeLink {
...
- (NSArray *)accessibilityElements {
    if (!_accessibilityElements) {
        @synchronized(self) {
            ...
            for (MSAttributedLabelLink *link in self.linkModels) {
...
- (void)longPressGestureDidFire:(UILongPressGestureRecognizer *)sender {
    switch (sender.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            MSAttributedLabelLink *link = [self linkAtPoint:touchPoint];
